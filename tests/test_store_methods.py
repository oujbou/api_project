...
class TestStore(unittest.TestCase):
    def test_get_all_traffic(self):
        ...
        visits = lille_sotre.get_all_traffic(date(year=2024, month=8, day=26))
    ...
    def test_get_sensor_traffic(self):
        ...
        visits = lille_store.get_sensor_trafic(2, date(2024, 8, 27))
        self.assertEqual(visits, 33)
    
    def test_sunday_closed(self):
        lille_store = StoreSensor("Lille", 1200, 300)
        visits = lille_store.get_sensor_trafic(2, date(2024, 9, 1))
